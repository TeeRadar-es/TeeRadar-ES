...
def aplicar_metodo_principal_a_campo(campo, metodo):
    ...
    actuales de TeeOne/Golfmanager hasta separar campo y método en la siguiente fase.
    """
    if not metodo:
        return campo
    ...
    if metodo.get("id_vendor_proveedor") is not None:
        campo["id_vendor_proveedor"] = metodo.get("id_vendor_proveedor")
...
def consultar_recorrido_teeone_v1(session, campo, recorrido, token, id_inicio, api, culture,
    ...
    payload = {
        ...
        "idTarifaTipoUso": 1,
        "idVendedor": str(campo.get("id_vendor")),
        "idVendedorProveedor": str(campo.get("id_vendor_proveedor")),
